    ...
    public class JsonUtils
    {
        public static JSONObject mapToJson(Map<?, ?> data)
        {
             ...
             */
                ...
                tmp = (Variant)entry.getValue();
                try {
                    object.put(key, tmp.getObject(new VariantTypeReference<String>(){}));
                }catch (Exception e)
                {
//                   e.printStackTrace();
                }
                try {
                    object.put(key, tmp.getObject(new VariantTypeReference<Integer>(){}));
...
//                    e.printStackTrace();
                ...
                try {
                    object.put(key, tmp.getObject(new VariantTypeReference<Float>(){}));
...
//                    e.printStackTrace();
                ...
                try {
                    object.put(key, tmp.getObject(new VariantTypeReference<Boolean>(){}));
